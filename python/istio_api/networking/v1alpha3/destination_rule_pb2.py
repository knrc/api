...
_OUTLIERDETECTION_HTTPSETTINGS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='healthy_panic_threshold', full_name='istio.networking.v1alpha3.OutlierDetection.HTTPSettings.healthy_panic_threshold', index=4,
