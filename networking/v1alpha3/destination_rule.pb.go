...
type OutlierDetection_HTTPSettings struct {
	...
	PanicThresholdPercent int32 `protobuf:"varint,5,opt,name=panic_threshold_percent,json=panicThresholdPercent,proto3" json:"panic_threshold_percent,omitempty"`
}
...
func (m *OutlierDetection_HTTPSettings) GetPanicThresholdPercent() int32 {
	if m != nil {
		return m.PanicThresholdPercent
	}
	return 0
}
...
func (m *OutlierDetection_HTTPSettings) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.PanicThresholdPercent != 0 {
		dAtA[i] = 0x28
		i++
		i = encodeVarintDestinationRule(dAtA, i, uint64(m.PanicThresholdPercent))
	}
	return i, nil
}
...
func (m *OutlierDetection_HTTPSettings) Size() (n int) {
	...
	if m.PanicThresholdPercent != 0 {
		n += 1 + sovDestinationRule(uint64(m.PanicThresholdPercent))
	}
	return n
}
...
func (m *OutlierDetection_HTTPSettings) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field PanicThresholdPercent", wireType)
			}
			m.PanicThresholdPercent = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowDestinationRule
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.PanicThresholdPercent |= (int32(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorDestinationRule = []byte{
	...
	,
}
