...
type OutlierDetection_HTTPSettings struct {
	...
	HealthyPanicThreshold int32 `protobuf:"varint,5,opt,name=healthy_panic_threshold,json=healthyPanicThreshold,proto3" json:"healthy_panic_threshold,omitempty"`
}
...
func (m *OutlierDetection_HTTPSettings) GetHealthyPanicThreshold() int32 {
	if m != nil {
...
func (m *OutlierDetection_HTTPSettings) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.HealthyPanicThreshold != 0 {
		dAtA[i] = 0x28
		i++
		i = encodeVarintDestinationRule(dAtA, i, uint64(m.HealthyPanicThreshold))
	}
	return i, nil
}
...
func (m *OutlierDetection_HTTPSettings) Size() (n int) {
	...
	if m.HealthyPanicThreshold != 0 {
		n += 1 + sovDestinationRule(uint64(m.HealthyPanicThreshold))
	}
	return n
}
	...
	for iNdEx < l {
		...
		case 5:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.HealthyPanicThreshold |= (int32(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorDestinationRule = []byte{
	...
	,
}
