...
type CircuitBreaker_SimpleCircuitBreakerPolicy struct {
	...
	HttpHealthyPanicThresholdPercent int32 `protobuf:"varint,10,opt,name=http_healthy_panic_threshold_percent,json=httpHealthyPanicThresholdPercent" json:"http_healthy_panic_threshold_percent,omitempty"`
}
...
func (m *CircuitBreaker_SimpleCircuitBreakerPolicy) GetHttpHealthyPanicThresholdPercent() int32 {
	if m != nil {
		return m.HttpHealthyPanicThresholdPercent
	}
	return 0
}
...
var fileDescriptor0 = []byte{
	...
	,
}
